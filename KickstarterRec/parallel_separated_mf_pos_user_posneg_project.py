...
class SeparatedParallelMFPosUserPosNegProjectEmbedding(BaseEstimator, TransformerMixin):
    ...
    def _update_separate_item_factors(self, XP, XPT, XN, XNT, FXP, FXPT, FXN, FXNT):
        ...
        self.beta = update_beta(None, self.gamma_p, self.gamma_n,
                                ...
                                None, XP, FXP, XN, FXN, self.c0, self.c1, self.lam_beta,
    ...
    def _update_item_biases(self, XP, XPT, XN, XNT, FXP, FXPT, FXN, FXNT):
        if self.verbose:
