...
import os
import sys
import mf_pos_embedding_user_project as mymodel1
import rec_eval
import cofactor
...
def _negative_coord_batch(lo, hi, train_data, prefix='project', max_neighbor_words=50, choose='macro'): #previous default max_neighbor_words is 50
    rows = []
    cols = []
