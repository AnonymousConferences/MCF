...
class ParallelMFPositiveNegativeUserProjectEmbedding(BaseEstimator, TransformerMixin):
    def __init__(self, mu_u_p = 1, mu_u_n = 1, mu_p_p = 1, mu_p_n = 1, n_components=100, max_iter=10, batch_size=1000,
